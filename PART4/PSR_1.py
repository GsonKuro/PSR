        ...
        while True:
            ...
            if args['use_time_mode']=="True": #If timemode was the option
                if (elapsed_time>=args["max_value"] or x==r.key.SPACE):
                    ...
                    dictionary(l,i,lst,elapsed_time,end,dt_end,dt_begin,hit_time,miss_time)
                    break
                
            else: #if inputmode was the option
                if i==args["max_value"] or x==r.key.SPACE:
...
def dictionary(l,i,lst,elapsed_time,end,dt_end,dt_begin,hit_time,miss_time):
    d={}
